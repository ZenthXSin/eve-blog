...
features:
  - icon:
    ...
    title: 注解教程
    details: kt-annotations 注解处理器：总览、注解参考、更新日志
    link: /annotations/
  - icon:
    ...
    title: 指南
    details: 核心概念、环境要求、快速开始、实战 mod、vanilla 组件库
    link: /guide/core-concepts
  - icon:
    ...
    title: 参考
    details: 生成代码、插件配置、已知限制
    link: /reference/generated-code
  - icon:
    ...
    title: 开发与维护
    details: 项目结构、三级验证体系（stub / headless / full 客户端）
    link: /dev/project-structure
  - icon:
      svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>'
    title: FAQ 与许可证
