...
hero:
  name: Eve's Blog
  text: Mindustry 模组教程
  tagline: JSON / Java / Kotlin 三轨教程 + 源码验证的机制结论与踩坑记录，每天持续补写
  actions:
    - theme: brand
      text: JSON 零基础
      link: /json/
...
features:
  - icon:
    ...
    title: JSON 模组教程
    details: 零基础起步：JSON 语法、环境与文件结构、内容定义；新增“给物品起中文名”练习与示例下载
    link: /json/
  - icon:
    ...
    title: Java 模组教程
    details: 已开篇：最小类 mod 与 Mod 生命周期、环境搭建与构建、内容定义与 Build 类、方块基础逻辑（定时器/查询/伤害/事件/联机）、绘制与动画（drawer 系统/自定义 draw/特效）；UI、Shader 陆续补写
    link: /java/
  - icon:
    ...
    title: Kotlin 模组教程
    details: kt-annotations 注解处理器与 arc-ui-dsl 的完整文档
    link: /kotlin/
  - icon:
    ...
    title: 机制与踩坑
    details: 源码验证过的结论：物品网络、fragBullet 门禁、天气属性、友军炮塔、shader 复刻等
    link: /mindustry/
---
